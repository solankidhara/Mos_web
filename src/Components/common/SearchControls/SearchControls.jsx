...
const SearchControls = (props) => {
      ...
      return (
            <div className={props['bs-class'] + ' ' + classes['browse-controls']}>
                  <select className="text-center" defaultValue={dd?dd :props.selected} onChange={contentTypeChangeHandler}>
                  ...
                  />
                  <Button type="button" className={classes.btn} icon="pi pi-search" onClick={submitHandler}/>
            </div>
      );
};
